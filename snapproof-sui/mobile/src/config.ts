/**
 * App configuration.
 * Values are read from environment variables (mobile/.env).
 * After redeploying the Move contract, update EXPO_PUBLIC_PROOF_PACKAGE_ID in mobile/.env
 */
...
// Update EXPO_PUBLIC_PROOF_PACKAGE_ID in mobile/.env after redeployment.
