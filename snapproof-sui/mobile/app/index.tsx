...
import { getBalance } from "../src/services/sui";
          ...
          <View style={styles.header}>
            ...
            <View style={styles.statusChip}>
              ...
              <Text style={styles.statusText}>
                Sui <Text style={{ color: C.slate }}>· {networkLabel}</Text>
              </Text>
            </View>
          </View>
        </FadeUp>
            ...
            <View style={styles.walletInner}>
              ...
              <View style={styles.statsGrid}>
                ...
                <View style={styles.statCell}>
                  ...
                  <Text style={[styles.statValue, { color: C.mint }]}>+12</Text>
                </View>
              </View>
              ...
              <View style={styles.walletFooter}>
                ...
                <Text style={styles.footerText}>
                  Last seal <Text style={{ color: C.silver }}>· 2m ago</Text>
                </Text>
              </View>
            </View>
          </GlassCard>
